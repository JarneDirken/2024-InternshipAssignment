...
export default function HistoryCard({ active, openModal, userId, items }: BorrowCardProps) {
                                ...
                                <div className="flex flex-row items-end w-5/6">
                                    ...
                                    <div className="flex flex-col w-1/3">
                                        <div className="truncate">
                                            <span>{calculateOnTime(item.endBorrowDate, item.requestDate)}</span>
                                        </div>
                                        <div className="truncate">
                                ...
                                <div className="p-2 flex items-center flex-wrap">
                                    ...
                                    <div className="flex w-1/2 flex-col items-end">
                                        <div className="flex items-center text-custom-primary gap-1 text-sm sm:text-base">
                                            {calculateOnTime(item.endBorrowDate)}
                                        </div>
