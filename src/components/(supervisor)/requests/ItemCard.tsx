...
export default function ItemCard({ active, openModal, items, itemLoading, setApproved, setRejected, setRequestStatusId, openMessageModal, setMessage, selectedTab, listRef, hasMore, innerRef }: BorrowCardProps) {
